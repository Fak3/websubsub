...
class DormantStaticSubscriptionChangeUrlnameTest(BaseTestCase):
    """
    When declared static subscription with the existing _dormant_ subscription 
    ...
    def test_dormant(self):
        ...
        # AND existing dormant Subscription in the database
        # (Does not have callback_url resolved)
